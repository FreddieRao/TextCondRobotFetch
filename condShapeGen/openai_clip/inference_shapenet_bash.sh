...
python openai_clip/inference_shapenet.py \
        ...
        --map_restore_file "openai_clip/finetune/results_no_ground/"$1\
        --norm 'LN'\
        --act_f 'tanh'\
        --l2norm \
        --num_layers 1\
        ...
        --nf_model 'realnvp' \
        --nf_restore_file "pytorch_flows/results/pytorch_flows/results_noground/"$2 \
        ...
        --embed_feat_test_path "occupancy_networks/out/voxels/onet_chair/generation/embed/03001627/embed_feats_val.pickle" \
        --out_mesh_folder 'occupancy_networks/out/voxels/onet_chair/generation/meshes_from_z/conditional/'$2 \
        --n_row 5\
        --quality \
        # --post_process $4 \
        # --vis_correct_only \
