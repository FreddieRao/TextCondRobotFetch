...
image_folder_table = "occupancy_networks/data/ShapeNet/04379243/"

# origin
clip_img_feat_path_chair = "../../data/embed_ShapeNetCore.v1/03001627/clip_img_feat_1view_texture_ground_keyshot_aug.pickle"
clip_img_feat_path_table = "../../data/embed_ShapeNetCore.v1/04379243/clip_img_feat_1view_texture_ground_keyshot.pickle"

embed_feat_path_chair = "occupancy_networks/out/voxels/onet_chair_latent/generation/embed/03001627/embed_feats.pickle"
embed_feat_path_table = "occupancy_networks/out/voxels/onet_table_latent/generation/embed/04379243/embed_feats.pickle"
...
class ClipImage2ShapeCache():
    ...
    def __init__(self, args, B_MappingNetwork=None, clip_img_feat_path=clip_img_feat_path_chair, embed_feat_path=embed_feat_path_chair, istrain=False):
        ...
        # Test and Val
        embed_feat_path = embed_feat_path.replace('embed_feats', 'embed_feats_val')
        with open(embed_feat_path, 'rb') as handle:
            embed_feats = pickle.load(handle) 
